...
MUTE_STATUS=$(perl -e 'alarm 1; exec @ARGV' /Applications/Hammerspoon.app/Contents/Frameworks/hs/hs -c "hs.audiodevice.defaultInputDevice():inputMuted()" 2>/dev/null || echo "false")
